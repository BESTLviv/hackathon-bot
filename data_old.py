...
class Data:
    ...
    def add_user(
        ...
        _id = self.user_collection.insert_one(
            {
                "name": name,
                "surname": surname,
                "username": username,
    ...
    def add_team(
        ...
        task_photo=None,
        task_text=None,
        partner_task_photo=None,
        partner_task_text=None,
        ...
        _id = self.team_collection.insert_one(
            {
                "name": name,
    ...
    def add_hackathon(
        ...
        _id = self.hackathon_collection.insert_one(
            {
                "name": name,
                "photo": photo,
    ...
    def add_partner(self, name, photo, description, clicks_count=0):
        ...
        _id = self.partner_collection.insert_one(
            {
                "name": name,
                "photo": photo,
                "description": description,
